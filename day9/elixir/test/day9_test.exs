defmodule Day9Test do
  ...
  # test "get value, relative mode (2) with offset 1 and existing memory access" do
  #   input = [1, 0, 0, 2, 99]
  #   assert(Day9.get_value(2, input, 3, %{offset: 1}) == {:ok, input, 99})
  # end

  # test "get value, relative mode (2) with offset 1 and non-existing memory access" do
  #   input = [1, 0, 0, 2, 99]
  #   assert(Day9.get_value(2, input, 6, %{offset: 1}) == {:error, input, 7})
  # end
  ...
  #   assert(Day9.process(pp, input, 0, %{offset: 0}, []) == [[3], [1105, 10, 3, 4, 2, 99]])
  # end
